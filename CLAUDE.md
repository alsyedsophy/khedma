...
- Domain layer: All UseCases and Repositories MUST return `Future<Either<Failure, T>>`.
- Presentation layer: Use the `.fold()` method to handle both Failure (Left) and Success (Right) states.
